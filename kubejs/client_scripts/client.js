...
JEIEvents.hideItems(event => {
  ...
  colors.forEach(color => {
	...
	event.hide(`createqol:refined_radiance_helmet`)
	event.hide(`createqol:refined_radiance_chestplate`)
	event.hide(`createqol:refined_radiance_leggings`)
	event.hide(`createqol:refined_radiance_boots`)
	event.hide(`createqol:shadow_steel_helmet`)
	event.hide(`createqol:shadow_steel_chestplate`)
	event.hide(`createqol:shadow_steel_leggings`)
	event.hide(`createqol:shadow_steel_boots`)
	event.hide(`createqol:shadow_steel_sword`)
	event.hide(`createqol:shadow_steel_pickaxe`)
	event.hide(`createqol:shadow_steel_axe`)
	event.hide(`createqol:shadow_steel_shovel`)
	event.hide(`createqol:shadow_steel_hoe`)
	event.hide(`createqol:shadow_radiance_sword`)
	event.hide(`createqol:shadow_radiance_pickaxe`)
	event.hide(`createqol:shadow_radiance_axe`)
	event.hide(`createqol:shadow_radiance_shovel`)
	event.hide(`createqol:shadow_radiance_hoe`)
	event.hide(`createqol:refined_radiance_sword`)
	event.hide(`createqol:refined_radiance_pickaxe`)
	event.hide(`createqol:refined_radiance_axe`)
